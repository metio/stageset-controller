...
`spec.errorBudget` and [`spec.updateWindows`](/gating/update-windows/) are combined
...
both. This complements a [promotion analysis](/gating/stage-promotion/), which
...
[promotion analysis](/gating/stage-promotion/), which shares this same metric
source contract.
