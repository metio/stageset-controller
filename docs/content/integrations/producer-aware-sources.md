...
[stages and sources](/defining-a-release/stages-and-sources/#source-kinds). Reach for it when an
...
producer side — see
[chaining snippets](https://jaas.projects.metio.wtf/defining-a-release/snippet-sources/#chaining-snippets).
