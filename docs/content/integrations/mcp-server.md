...
[stage gate endpoint](/guides/progressive-delivery/), the server is
best-effort: if its port can't bind the controller logs the failure and keeps
reconciling.
