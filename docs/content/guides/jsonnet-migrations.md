...
A [migration ladder](/gating/versioned-migrations/) is just data — a list of
...
The chain mirrors [From Jsonnet to a gated rollout](/get-started/jsonnet-to-rollout/),
...
- **Verify and pin** the source in production — see
  [Verifying and pinning the source](/gating/versioned-migrations/#verifying-and-pinning-the-source).
