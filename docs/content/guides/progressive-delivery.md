...
([production](/running/production/#network-policy)) to admit only your
delivery controller.
...
[ready checks](/defining-a-release/ready-checks/) accept CEL, a StageSet stage can wait on an
