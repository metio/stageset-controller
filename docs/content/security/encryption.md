...
In a [single-tenant cluster-admin](/security/multi-cluster/#single-tenant-cluster-admin)
...
output is persisted is the optional [rollback store](/gating/rollback/), which is
...
[encryption at rest](/gating/rollback/#encryption-at-rest).
